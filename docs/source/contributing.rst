...
The best way to send feedback is to file an issue at https://github.com/aalexmmaldonado/reptar/issues.
...
Ready to contribute? Here's how to set up ``reptar`` for local development.

1. Fork the ``reptar`` repo on GitHub.
