...
**Rep**\ roducible, **t**\ ailorable **ar**\ chive (i.e., reptar) provides an easy way to store (hopefully to release openly) and analyze computational chemistry data.
...
At the moment, the only way to install reptar is directly from the `GitHub repository <https://github.com/aalexmmaldonado/reptar>`_.
